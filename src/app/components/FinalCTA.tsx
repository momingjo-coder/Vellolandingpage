              ...
              <div className="flex flex-col items-center max-w-[620px]">
                ...
                <div className="flex flex-wrap items-center justify-center gap-4">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center px-9 py-4 rounded-full bg-white/10 text-white border border-white/40 font-bold text-[16px] md:text-[17px] hover:bg-white/20 active:translate-y-[1px] transition-all backdrop-blur-sm cursor-pointer"
                  >
                    소개서 다운받기
                  </button>
                </div>
