      ...
      <div className="container mx-auto max-w-[1080px] relative z-10">
        <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-8 items-center">
          <div>
            ...
            <h1 className="text-[clamp(28px,3.8vw,42px)] font-bold tracking-tight leading-[1.3] mb-5 whitespace-pre-line font-[Paperozi] p-[0px] break-keep"><span className="whitespace-nowrap">아직도 국내에서만 인재를 찾고 계신가요?</span>{"\n검증된 베트남 핵심 인재 채용으로\n기업의 생산성을 높이세요."}</h1>

            <p className="text-[16px] leading-[1.65] text-[#334155] mb-8 font-[Paperozi]">체계적인 프로세스와 채용 전담 매니저 케어,<br />벨로의 구독형 서비스로 빠르게 매칭하고 관리합니다.</p>
